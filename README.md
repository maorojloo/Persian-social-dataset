...
این مخزن شامل مجموعه‌ای از دیتاست‌های فارسی است که با هدف کمک به برنامه‌نویسان، تحلیلگران یا مهندسن داده و کسانی که می‌خواهند کارهای تحلیلی روی داده‌های فارسی رو شروع کنن، گردآوری شده. در این ریپازیتوری، هر دیتاست همراه با توضیحات مختصر و لینک مربوط به صفحه Kaggle ارائه شده تا بتوانید به راحتی از منابع استفاده کنید و یاد بگیرید :)
