...
من سعی کردم یک قدم کوچک برای جامعه‌مون بردارم. حدود ۳۰ میلیون رکورد دیتای گمنام‌شده از شبکه‌های اجتماعی فارسی رو روی Kaggle منتشر کردم تا همه بتونن آزادانه ازش استفاده کنن. 🎉🎉

###  *🔍 این دیتاست چه کمکی به جامعه‌ی تکنولوژی ایران می‌کنه؟*
- کمک به توسعه‌ی مدل‌های زبانی فارسی
- فراهم کردن بستری برای آموزش و فعالیت‌های پژوهشی
- و کلی کاربرد دیگه...

 **اگه با این دیتا کار جالبی انجام دادید، خوشحال می‌شم خبرم کنید ✍️ :))**
 <br/>
ممنونم از شرکت هشتگ [8tag.ir](https://8tag.ir/) بابت همکاری در راستای انجام این مسئولیت اجتماعی.
